...
| Field | Value |
|-------|-------|
| **title** | How to Start a Small Cafe: Inventory, Staff, and Waste |
| **slug** | `how-to-start-a-small-cafe-inventory-staff-waste` |
| **language** | `en` |
| **translationKey** | `start-small-cafe-operations` |
| **excerpt** | Opening a cafe is the easy part. Keeping milk in stock, staff on shift, and waste off your P&L is where most owners bleed money. Here is a practical setup guide. |
| **seoTitle** | How to Start a Small Cafe and Manage Inventory, Staff & Waste |
| **seoDescription** | Learn how to start a small cafe with systems for inventory, staff scheduling, and waste tracking. Compare Notion, Google Sheets, and KitchFlow. |
| **category** | Operations |
| **readTime** | 12 |
| **publishedAt** | 2026-08-27 |
| **coverImage** | https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=1600&q=80 |
| **coverImageAlt** | Small cafe interior with wooden tables and natural light. Photo by Jonas Kakaroto on Unsplash. |
...
1. [Before you open: the numbers that matter](#before-you-open-the-numbers-that-matter)
2. [Inventory for a small cafe](#inventory-for-a-small-cafe)
3. [Staff and scheduling without the drama](#staff-and-scheduling-without-the-drama)
4. [Waste: where margin quietly disappears](#waste-where-margin-quietly-disappears)
5. [Tools compared: Google Sheets, Notion, and KitchFlow](#tools-compared-google-sheets-notion-and-kitchflow)
6. [Your first 30 days checklist](#your-first-30-days-checklist)
7. [FAQ](#faq)

![Barista working behind a cafe counter](https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=1200&q=80)
*Barista at work behind the counter. Photo by [Nathan Dumlao](https://unsplash.com/photos/person-making-latte-art-6VhPY27jdps) on Unsplash.*

## Before you open: the numbers that matter

Most small cafes in the US and Europe launch with **$80,000 to $300,000** in startup costs, depending on build-out, equipment, and location ([U.S. Small Business Administration](https://www.sba.gov/business-guide/launch-your-business/fund-your-business)). That range is wide on purpose. A kiosk costs less than a full sit-down room with a pastry kitchen.

What matters more after opening is **food cost percentage**. For cafes, operators often target **28% to 35%** of revenue on ingredients ([National Restaurant Association](https://restaurant.org/research-and-media/research/research-reports/state-of-the-industry/)). Miss that by five points and you are not "a little tight." You are working for suppliers instead of yourself.
...
**Waste as % of purchases.** Industry studies put pre-consumer food waste in food service around **4% to 10%** of food purchased ([ReFED](https://refed.org/food-waste/the-problem/)). Cafes with pastry cases often sit at the high end.
...
![Fresh produce and ingredients in a kitchen](https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&q=80)
*Stocked produce ready for prep. Photo by [Louis Hansel](https://unsplash.com/photos/assorted-vegetables-on-display-MP0bgaS_d1I) on Unsplash.*
...
Cafe staff turnover runs high. Food service often sees **70% or more annually** ([National Restaurant Association](https://restaurant.org/research-and-media/research/)). Small teams feel every quit. You cannot fix that by hiring harder. Write down what each shift owns.
...
![Kitchen team coordinating during service](https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=1200&q=80)
*Staff coordinating in a busy kitchen. Photo by [Louis Hansel](https://unsplash.com/photos/chef-cooking-in-kitchen-1c627977JyM) on Unsplash.*
...
Related read: [How to build an accountable kitchen team](/blog/accountable-kitchen-team).
...
|--------|---------|-------------------|
| **Spoilage** | Expired milk, stale bread | Ordering or rotation issue |
| **Prep error** | Burnt batch, wrong recipe | Training or recipe card issue |
| **Overproduction** | Unsold pastries | Forecasting or display issue |
| **Customer return** | Wrong drink remade | POS or communication issue |
...
![Compost bin with food scraps in a cafe kitchen](https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&q=80)
*Separating food waste for compost. Photo by [Kate](https://unsplash.com/photos/person-holding-green-plant-11SdUn03NOM) on Unsplash.*

Related read: [How to reduce kitchen waste by 40%](/blog/reduce-kitchen-waste).
...
| Item | Unit | On hand | Par | Order? |
|------|------|---------|-----|--------|
| Oat milk | L | 22 | 48 | Yes |
...
Notion publishes [free team workspace templates](https://www.notion.com/templates/category/project-management); search "inventory tracker" and adapt for F&B units (kg, L, cases).
...
Related read: [The ultimate guide to kitchen inventory management](/blog/kitchen-inventory-management).
...
In the US, many operators spend **$80,000 to $300,000** depending on size, city, and equipment ([SBA](https://www.sba.gov/business-guide/launch-your-business/fund-your-business)). Budget 3 to 6 months of operating cash beyond build-out. Rent and labor usually beat ingredient cost in the first year.
...
Many operators target **28% to 35%** of revenue ([National Restaurant Association](https://restaurant.org/research-and-media/research/research-reports/state-of-the-industry/)). Specialty coffee shops with low food sales may run lower; full brunch menus often run higher.
...
Log every discard with a reason for two weeks, enforce FIFO in the pastry case, portion with scales, and tie production to sales by daypart. Most cafes cut preventable waste **15% to 25%** once they measure ([ReFED](https://refed.org/food-waste/the-problem/)).
...
| Item | Detail |
|------|--------|
| **Intent** | Informational, new cafe owners learning ops basics |
| **Primary keyword** | how to start a small cafe |
| **Secondary keywords** | cafe inventory management, cafe staff scheduling, reduce cafe waste |
| **Title** | How to Start a Small Cafe: Inventory, Staff, and Waste |
| **Meta** | Learn how to start a small cafe with systems for inventory, staff scheduling, and waste tracking. Compare Notion, Google Sheets, and KitchFlow. |
| **Open questions** | Confirm KitchFlow launch timeline for CTA; add local regulation links if targeting a specific country |
| **[needs source]** | Receiving error rate 2–5% operator benchmark |
