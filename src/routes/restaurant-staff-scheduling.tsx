...
const content = featurePageByPath("/restaurant-staff-scheduling")!;
const URL = `${SITE_URL}${content.path}`;

export const Route = createFileRoute("/restaurant-staff-scheduling")({
  head: () => ({
    meta: socialMetaTags({
      ...
      imageAlt: "KitchFlow employee scheduling",
      type: "website",
    }),
