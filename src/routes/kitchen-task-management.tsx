...
const content = featurePageByPath("/kitchen-task-management")!;
const URL = `${SITE_URL}${content.path}`;

export const Route = createFileRoute("/kitchen-task-management")({
  head: () => ({
    meta: socialMetaTags({
      ...
      imageAlt: "KitchFlow kitchen task management",
      type: "website",
    }),
